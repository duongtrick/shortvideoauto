...
- Admin audit logs API supports action/entity filters behind admin role guard.
- Affiliate content policy check flags sensitive claims and can append disclosure text before render/post.
